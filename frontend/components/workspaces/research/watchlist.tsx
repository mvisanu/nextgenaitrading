...
export default function OpportunitiesPage() {
  ...
  if (error) return <div role="alert" className="py-6 text-sm">
    <p>Watchlist data could not be loaded.</p>
    <button className="mt-3 min-h-11 rounded-md border border-border px-4" onClick={() => void refetch()}>Retry</button>
  </div>;
